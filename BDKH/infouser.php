...
<body id="view_user">
    ...
    $result = pg_query($conn, "select * from public.user where tentk = '$tentk'");
...
<tr class="bg-success">
	    ...
	    <tr>
	        <td>
				...
				<a class="text-danger" href="#' . $row->tentk . '">Chỉnh sửa tài khoản</a>
				</br>
				<a class="text-danger" href="#' . $row->tentk . '">Đổi mật khẩu</a>
				</br>
				<a class="text-danger" href="#' . $row->tentk . '">Xóa tài khoản</a>
			</div>
	        </td> 
	    </tr>
	</table>
