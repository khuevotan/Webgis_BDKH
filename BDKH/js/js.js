...
$("#document").ready(function() {
    ...
    var TINHTHANH = new ol.layer.Image({
    ...
    var map = new ol.Map({
      target: "map",
      layers: [QUOCGIA, TINHTHANH, LUONGMUA, LUONGMUA2, LUONGMUA3, NHIETDO ,NHIETDO2, NHIETDO3, DAO, QUOCLO, SONG, THUDO, UBNDTINH],
    ...
    $("#chkTINHTHANH").change(function() {
      if ($("#chkTINHTHANH").is(":checked")) {
        TINHTHANH.setVisible(true);
      } else {
        TINHTHANH.setVisible(false);
      }
    });
